...
<TabItem label="AWS Account" value="AWS Account">

<Tabs>

<TabItem label="Using the Access Credentials Method" value="Using the Access Credentials Method">
...
<TabItem label="Using the Security Token Service (STS) Method" value="Using the Security Token Service (STS) Method">
...
<TabItem label="AWS GovCloud Account" value="AWS GovCloud Account">
